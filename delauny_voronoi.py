...
if __name__ == '__main__':
    ...
    #----------------------------------
    # Read in the image.
    img = cv2.imread("C:/Users/dell/Desktop/ML Robot Pattern formation/CODES/octagon.png");
    #image resize
    width = 500 #Y
    height = 500 #X
    dim = (width, height)
    ...
    with open("C:/Users/dell/Desktop/ML Robot Pattern formation/CODES/newPoints.txt") as file :
        for line in file :
            x, y = line.split()
